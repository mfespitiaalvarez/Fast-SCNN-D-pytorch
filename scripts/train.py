...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='fast_scnn',
                        help='model name (default: fast_scnn, use fast_scnn_d for disparity model)')
    ...
    parser.add_argument('--batch-size', type=int, default=8,
                        metavar='N', help='input batch size for training (default: 8, increase for RTX 5070)')
    ...
    parser.add_argument('--num-workers', type=int, default=8,
                        metavar='N', help='number of data loading workers (default: 8, adjust based on CPU cores)')
    # checking point
...
class Trainer(object):
    def __init__(self, args):
        ...
        # create network
        # Use fast_scnn_d model if dataset is citys_d, otherwise use standard fast_scnn
        if args.model == 'fast_scnn_d' or args.dataset == 'citys_d':
            self.model = get_fast_scnn_d(dataset=args.dataset, aux=args.aux)
        else:
